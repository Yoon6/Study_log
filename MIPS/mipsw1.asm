...
array: .word 3, 24, 18 # Define a variable named array as a word (integer) array.
...
main:
	...
	addi $a2, $zero, 2 # Set argument 3 to (high = 7, last index in array)
...
print:
		...
		while_print:
			beq $t0, 12, exit_print 	# 인덱스와 스택의 개수가 같으면 탈출 
